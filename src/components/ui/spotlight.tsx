...
/**
 * Spotlight — efecto de luz que sigue al cursor dentro del contenedor padre.
 * Uso: colocar <Spotlight /> dentro de un contenedor con position: relative y overflow: hidden.
 */
